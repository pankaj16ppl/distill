...
async function fetchSearchResults(query) {
  ...
  // Prevent another search until the current one is finished
  if (searchInProgress) {
    console.log("Search already in progress. Ignoring new search.");
    return [];
  }
  ...
  try {
    ...
    // Unlock only after the search has completely finished
